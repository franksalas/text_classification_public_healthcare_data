...
def normalize_corpus(corpus, html_stripping=False, replace_medical_names=True, contraction_expansion=True,
    ...
    for doc in corpus:
        ...
        # removereplace_medical_names
        if replace_medical_names:
            doc = replace_medical(doc)        
        # expand contractions    
